  ...
  return (
    <>
      <div className="carousel w-full">
        <div id="slide1" className="carousel-item relative w-full h-56 sm:h-96">
        ...
        <div id="slide2" className="carousel-item relative w-full h-56 sm:h-96">
        ...
        <div id="slide3" className="carousel-item relative w-full h-56 sm:h-96">
